"""Deterministic final-workstation UI fixture without live data."""
...
research = build_apple_research_profile(current, history)
...
market_price = candidate_run.per_share_value.intrinsic_value_per_share * 1.25
...
app.render_fundamental_quality(ticker, history, "USD")
